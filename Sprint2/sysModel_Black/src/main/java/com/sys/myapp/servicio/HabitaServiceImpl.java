...
public class HabitaServiceImpl implements HabitacionService {
	...
	@Override
	@Transactional
	public boolean desocupareserva(Integer habitaid, LocalDate fecha) {
	...
	@Override
	@Transactional
	public void ocupar(Integer habitaid, LocalDate fecha) {
		habirepos.ocupar(habitaid, fecha);
	}

	@Override
	@Transactional
	public boolean desocupafisica(Integer habitaid, LocalDate fecha) {
		return habirepos.desocupafisica(habitaid,fecha);
	}
