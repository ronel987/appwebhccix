...
public interface HabitacionRepository extends JpaRepository<Habitacion,Integer> {
  ...
  //lista de Habitaciones disponibles por fecha_ingresa:sí retorna un Set<Habitacion>
    ...
    public abstract boolean desocupareserva (Integer habitaid, LocalDate fecha);
  ...
  // con el checkout_al pagar: desocupa fisicamente: debe ser para una fecha_salida
    ...
    public abstract boolean desocupafisica (Integer habitaid, LocalDate fecha);  
    ...
    public abstract void ocupar (Integer habitaid, LocalDate fecha);     
}
