...
public class ImagenController {
    ...
    public String registrar_POST(@RequestPart("picture")MultipartFile picture,Imagen imagen,RedirectAttributes flash) throws IOException
    {   //picture es el name de la etiketa input
        ...
        flash.addFlashAttribute("success", "Imagen Guardada Exitosamente");
        return "redirect:/Imagen/imagen_registrar";
    }
    ...
    public String editar_GET(Model model,@PathVariable Integer imagenId, Map map,HttpSession session){
        ...
        Habitacion habita=imaModel.getHabitacion();
        map.put("bHabita", habita);
