...
public class HabitacionController {
  ...
  //final:es constante /set : no se repita
   //public final  static Set<Habitacion> listad = new HashSet<>() ; 
    ...
    public String registrar_POST(Habitacion habita,RedirectAttributes flash){         
		...
		for (Habitacion aut: listado  ) {
		  if(aut.getNumero().equals(habita.getNumero()) ) {
			  flash.addFlashAttribute("error","Habitación ya Existe");
			  return "redirect:/Habita/habita_registrar";
		  }
		}
		habitaService.insert(habita);
		flash.addFlashAttribute("success", "Habitación Guardada Exitosamente");
        return "redirect:/Habita/habita_registrar";   
    }    
    ...
    @GetMapping(value = "/opciones")    //llega fecha de ingreso
