...
public class ClienteController {
    ...
    public String registrar_POST(Cliente cliente,RedirectAttributes flash){        //cliente llega cargado(sin id) pero debo insertar 1ro una persona 
        ...
        return "redirect:/Cliente/cliente_registrar";   
    }    
