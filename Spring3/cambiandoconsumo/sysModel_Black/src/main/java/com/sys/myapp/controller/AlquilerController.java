...
public class AlquilerController {
    ...
    public String registrar_POST(Alquiler alquiler,RedirectAttributes flash){        
		alquilerService.insert(alquiler);	  
		flash.addFlashAttribute("success", "Alquiler Guardado Exitosamente");
        ...
        return "redirect:/Alquiler/{idreserva}/alquiler_registrar";   
    }    
