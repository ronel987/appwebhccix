...
public class Alquiler implements Serializable {
	...
	@Column (name="deudaaloja", nullable=false)
	private Double deudaaloja;	
	...
	@OneToMany(mappedBy="alquiler")   //envia su heredero o referencia,
    private Collection<Consumo> itemsCo=new ArrayList<>();  //un Alquiler tiene su coleccion de consumos
	
	public Alquiler() {
	}

	public Alquiler(Integer idalquiler, LocalDate fecha_ingreso, LocalDate fecha_salida, Double costo_alojamiento,
			Double costototal, Double deudaaloja, Double deuda, String estado) {
		this.idalquiler = idalquiler;
		this.fecha_ingreso = fecha_ingreso;
		this.fecha_salida = fecha_salida;
		this.costo_alojamiento = costo_alojamiento;
		this.costototal = costototal;
		this.deudaaloja= deudaaloja;
		this.deuda = deuda;
		this.estado = estado;
	}
	...
	public Double getDeudaaloja() {
		return deudaaloja;
	}

	public void setDeudaaloja(Double deudaaloja) {
		this.deudaaloja = deudaaloja;
	}
