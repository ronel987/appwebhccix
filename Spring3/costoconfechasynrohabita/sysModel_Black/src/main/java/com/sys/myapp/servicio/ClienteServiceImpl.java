...
public class ClienteServiceImpl implements ClienteService {
	...
	public Optional<Cliente> findById2(Integer clienteId) {
		...
		return clienterepos.findById2(clienteId);
	}

	@Override
	@Transactional (readOnly=true)
	public Optional<Cliente> findByLoginyPassword(String login, String password) {		
		return clienterepos.findByLoginyPassword(login, password);
	}
