...
public class ConsumoServiceImpl implements ConsumoService {
	...
	@Override
	@Transactional (readOnly=true)
	public Collection<Object> consumosxIdAlquiler(Integer reservaId) {
		return conrepos.consumosxIdAlquiler(reservaId);
	}

	@Override
	@Transactional
	public void actualizarestado(Integer idconsumo) {
		
		conrepos.actualizarestado(idconsumo);
	}
