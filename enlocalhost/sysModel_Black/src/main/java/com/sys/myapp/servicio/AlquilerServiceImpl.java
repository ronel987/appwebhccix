...
public class AlquilerServiceImpl implements AlquilerService {
	...
	@Override
	@Transactional
	public void subircostotxconsumo(Double preciototal, Integer idalquiler) {
		alquilerepos.subircostotxconsumo(preciototal, idalquiler);		
	}


	@Override
	@Transactional
	public void subirdeudaaloja(Double costoaloja, Integer idalquiler) {
		alquilerepos.subirdeudaaloja(costoaloja, idalquiler);
	}

	@Override
	@Transactional
	public void bajardeuda(Double montopagado, Integer idalquiler) {
		alquilerepos.bajardeuda(montopagado, idalquiler);
	}

	@Override
	@Transactional (readOnly=true)
	public Collection<String> obtenerlistanumdocs() {		
		return alquilerepos.obtenerlistanumdocs();
	}

	@Override
	@Transactional
	public void subirdeudaconsumo(Double costo, Integer idalquiler) {
		alquilerepos.subirdeudaconsumo(costo, idalquiler);		
	}

	@Override
	@Transactional
	public void bajardeudaaloja(Double pago, Integer idalquiler) {
		alquilerepos.bajardeudaaloja(pago, idalquiler);		
	}
