...
public class TrabajadorServiceImpl implements TrabajadorService {
	...
	public Trabajador findById(Integer trabaId) {		
		return trarepos.findById(trabaId).orElse(null);
	}
	...
	@Override
	@Transactional (readOnly=true)
	public Trabajador findByLogin(String login) {
	...
	@Override
	@Transactional (readOnly=true)
	public Trabajador findByLoginyPassword(String login, String password) {		
