...
public interface ClienteRepository extends JpaRepository<Cliente,Integer> {
  ...
  //lista de datos de 2 tablas pa el detalle de cliente:devuelve 1 fila
    ...
    @Query(value="select c.idpersona,c.codigo_cliente,c.ruc,c.razonsocial from cliente c inner join persona p on p.idpersona=c.idpersona where p.num_documento=?1",nativeQuery=true)
