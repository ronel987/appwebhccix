...
public class Reserva implements Serializable {
	...
	private Date fecha_ingresa;    //con Date no inserta reserva porq no puede convertir de String a Date
	...
	public Reserva(Integer idreserva, Date fecha_reserva, Date fecha_ingresa, Date fecha_salida, Double costo_alojamiento,
			String estado) {
