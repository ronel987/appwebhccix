...
public interface ReservaRepository extends JpaRepository<Reserva,Integer> {
  ...
  //lista de Reservas por una fecha y subconsultas
    @Query(value="select r.idreserva,r.idhabitacion,h.numero,(select nombre from persona where idpersona=r.idcliente)as clienten,\"+\r\n"
    		...
    		+ "\"r.tipo_reserva,r.fecha_reserva,r.fecha_ingresa,r.fecha_salida,r.costo_alojamiento,r.estado from"
    ...
    //pagar reserva
    @Query(value="update reserva set estado='Pagada' where idreserva=?",nativeQuery=true)	
