...
public class ReservaController {
    ...
    public String registrar_POST(Reserva reserva){        
		...
		LocalDate fecha= reserva.getFecha_ingresa();       //esto is ok
		TemporalField temporal =null;
		
		Date fechadate= fecha.getLong(null); 
		temporal = new java.sql.Date();
		//Date fecha = new java.sql.Date(reserva.getFecha_ingresa().getLong(null));
		//if (fecha !=null)
		habitaService.ocupar(2, fechadate);
		//habitaService.ocupar(reserva.getHabitacion().getIdhabitacion(), new java.sql.Date(2022-11-21));
		//habitaService.ocupar(reserva.getHabitacion().getIdhabitacion(), reserva.getFecha_ingresa().get(null));
