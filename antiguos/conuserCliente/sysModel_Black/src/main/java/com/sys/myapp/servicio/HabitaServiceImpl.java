...
public class HabitaServiceImpl implements HabitacionService {
	...
	@Override
	@Transactional (readOnly=true)
	public Collection<Habitacion> habitaDisponiblesxpiso(String piso,Integer calenid) {
		return habirepos.habitaDisponiblesxpiso(piso,calenid);
	}

	@Override
	@Transactional
	public boolean desocupar(Integer habitaid,Integer calenid) {
		return habirepos.desocupar(habitaid,calenid);
	}

	@Override
	@Transactional
	public boolean ocupar(Integer habitaid,Integer calenid) {
		return habirepos.ocupar(habitaid,calenid);
	}
